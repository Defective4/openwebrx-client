...
public enum Modulation {
    ...
    freedv("FreeDV", 300, 3000), fst4("FST4", usb), fst4w("FST4W", 1350, 1650), ft4("FT4", usb),
    ft8("FT8", usb, FT8Message.class), hdr("HDR", -200000, 200000), hfdl("HFDL", 0, 3000), ism("ISM", -1000, 1000),
